...
## 📅 Last Updated: **2025-03-05 16:29:03 UTC**
...
| IDR             | Indonesia                 | 1 IDR = 162.82 INR |
...
| LAK             | Laos                 | 1 LAK = 216.55 INR |
| LBP             | Lebanon                 | 1 LBP = 894.66 INR |
...
| MGA             | Madagascar                 | 1 MGA = 46.56 INR |
...
| UGX             | Uganda                 | 1 UGX = 36.66 INR |
| UYU             | Uruguay                 | 1 UYU = 0.43 INR |
| UZS             | Uzbekistan                 | 1 UZS = 128.81 INR |
| VES             | Unknown Country                 | 1 VES = 0.64 INR |
| VND             | Vietnam                 | 1 VND = 255.05 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.25 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 6.13 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.13 INR |
| XPF             | CFP Franc                 | 1 XPF = 1.12 INR |
