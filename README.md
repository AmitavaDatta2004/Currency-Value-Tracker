...
## 📅 Last Updated: **2026-07-03 10:36:06 UTC**
...
| KRW             | South Korea                 | 1 KRW = 15.31 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.73 INR |
| LAK             | Laos                 | 1 LAK = 223.53 INR |
| LBP             | Lebanon                 | 1 LBP = 892.37 INR |
...
| MGA             | Madagascar                 | 1 MGA = 42.33 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.26 INR |
| UAH             | Ukraine                 | 1 UAH = 0.45 INR |
| UGX             | Uganda                 | 1 UGX = 36.52 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 118.72 INR |
| VES             | Unknown Country                 | 1 VES = 6.39 INR |
| VND             | Vietnam                 | 1 VND = 262.96 INR |
