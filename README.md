...
## 📅 Last Updated: **2026-05-29 03:49:04 UTC**
...
| KZT             | Kazakhstan                 | 1 KZT = 4.82 INR |
| LAK             | Laos                 | 1 LAK = 218.31 INR |
| LBP             | Lebanon                 | 1 LBP = 895.33 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.27 INR |
...
| MGA             | Madagascar                 | 1 MGA = 41.87 INR |
...
| TRY             | Turkey                 | 1 TRY = 0.46 INR |
| TTD             | Trinidad and Tobago                 | 1 TTD = 0.07 INR |
| TWD             | Taiwan                 | 1 TWD = 0.31 INR |
| TZS             | Tanzania                 | 1 TZS = 26.15 INR |
| UAH             | Ukraine                 | 1 UAH = 0.44 INR |
| UGX             | Uganda                 | 1 UGX = 37.62 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 119.55 INR |
| VES             | Unknown Country                 | 1 VES = 5.44 INR |
| VND             | Vietnam                 | 1 VND = 263.22 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.63 INR |
