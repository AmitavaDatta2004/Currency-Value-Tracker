...
## 📅 Last Updated: **2025-09-17 08:26:05 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 28.25 INR |
...
| KZT             | Kazakhstan                 | 1 KZT = 5.38 INR |
| LAK             | Laos                 | 1 LAK = 215.81 INR |
| LBP             | Lebanon                 | 1 LBP = 891.70 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.01 INR |
| LRD             | Liberia                 | 1 LRD = 1.77 INR |
...
| MDL             | Moldova                 | 1 MDL = 0.16 INR |
| MGA             | Madagascar                 | 1 MGA = 43.85 INR |
...
| UGX             | Uganda                 | 1 UGX = 34.88 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 122.93 INR |
| VES             | Unknown Country                 | 1 VES = 1.60 INR |
| VND             | Vietnam                 | 1 VND = 263.75 INR |
