...
## 📅 Last Updated: **2025-05-12 16:26:05 UTC**
...
| HUF             | Hungary                 | 1 HUF = 3.65 INR |
| IDR             | Indonesia                 | 1 IDR = 166.73 INR |
...
| MGA             | Madagascar                 | 1 MGA = 44.86 INR |
...
| UGX             | Uganda                 | 1 UGX = 36.53 INR |
| UYU             | Uruguay                 | 1 UYU = 0.42 INR |
| UZS             | Uzbekistan                 | 1 UZS = 128.55 INR |
| VES             | Unknown Country                 | 1 VES = 0.93 INR |
| VND             | Vietnam                 | 1 VND = 259.71 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.21 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.91 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.91 INR |
| XPF             | CFP Franc                 | 1 XPF = 1.07 INR |
| YER             | Yemen                 | 1 YER = 2.44 INR |
| ZAR             | South Africa                 | 1 ZAR = 0.18 INR |
| ZMK             | Zambia (Old Currency)                 | 1 ZMK = 90.01 INR |
| ZMW             | Zambia                 | 1 ZMW = 0.26 INR |
