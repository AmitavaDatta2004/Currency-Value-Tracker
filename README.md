...
## 📅 Last Updated: **2025-09-19 08:25:07 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 28.24 INR |
...
| IDR             | Indonesia                 | 1 IDR = 166.14 INR |
...
| KRW             | South Korea                 | 1 KRW = 13.96 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 5.44 INR |
| LAK             | Laos                 | 1 LAK = 217.82 INR |
| LBP             | Lebanon                 | 1 LBP = 900.92 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.04 INR |
| LRD             | Liberia                 | 1 LRD = 1.78 INR |
...
| MGA             | Madagascar                 | 1 MGA = 44.21 INR |
...
| UGX             | Uganda                 | 1 UGX = 35.23 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 123.29 INR |
| VES             | Unknown Country                 | 1 VES = 1.63 INR |
| VND             | Vietnam                 | 1 VND = 263.86 INR |
