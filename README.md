...
## 📅 Last Updated: **2025-07-16 08:29:15 UTC**
...
| IDR             | Indonesia                 | 1 IDR = 162.79 INR |
...
| KZT             | Kazakhstan                 | 1 KZT = 5.29 INR |
| LAK             | Laos                 | 1 LAK = 216.99 INR |
| LBP             | Lebanon                 | 1 LBP = 895.86 INR |
...
| MGA             | Madagascar                 | 1 MGA = 44.63 INR |
...
| PKR             | Pakistan                 | 1 PKR = 2.86 INR |
| PLN             | Poland                 | 1 PLN = 0.04 INR |
| PYG             | Paraguay                 | 1 PYG = 77.94 INR |
...
| UGX             | Uganda                 | 1 UGX = 36.08 INR |
| UYU             | Uruguay                 | 1 UYU = 0.41 INR |
| UZS             | Uzbekistan                 | 1 UZS = 127.83 INR |
| VES             | Unknown Country                 | 1 VES = 1.17 INR |
| VND             | Vietnam                 | 1 VND = 261.57 INR |
