...
## 📅 Last Updated: **2025-04-06 08:23:11 UTC**
...
| KRW             | South Korea                 | 1 KRW = 14.61 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 5.08 INR |
| LAK             | Laos                 | 1 LAK = 216.15 INR |
| LBP             | Lebanon                 | 1 LBP = 900.13 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.65 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 36.57 INR |
| UYU             | Uruguay                 | 1 UYU = 0.42 INR |
| UZS             | Uzbekistan                 | 1 UZS = 129.35 INR |
| VES             | Unknown Country                 | 1 VES = 0.71 INR |
| VND             | Vietnam                 | 1 VND = 257.85 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.22 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.99 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.99 INR |
