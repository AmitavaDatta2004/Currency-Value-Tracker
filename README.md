...
| KZT             | Kazakhstan                 | 1 KZT = 5.31 INR |
| LAK             | Laos                 | 1 LAK = 216.94 INR |
| LBP             | Lebanon                 | 1 LBP = 899.08 INR |
...
| MGA             | Madagascar                 | 1 MGA = 45.07 INR |
...
| PKR             | Pakistan                 | 1 PKR = 2.84 INR |
| PLN             | Poland                 | 1 PLN = 0.04 INR |
| PYG             | Paraguay                 | 1 PYG = 70.99 INR |
...
| TZS             | Tanzania                 | 1 TZS = 24.53 INR |
| UAH             | Ukraine                 | 1 UAH = 0.42 INR |
| UGX             | Uganda                 | 1 UGX = 34.95 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 120.46 INR |
| VES             | Unknown Country                 | 1 VES = 2.21 INR |
| VND             | Vietnam                 | 1 VND = 263.06 INR |
