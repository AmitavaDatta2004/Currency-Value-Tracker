...
| KES             | Kenya                 | 1 KES = 1.31 INR |
| KGS             | Kyrgyzstan                 | 1 KGS = 0.87 INR |
| KHR             | Cambodia                 | 1 KHR = 40.87 INR |
...
| KZT             | Kazakhstan                 | 1 KZT = 5.26 INR |
| LAK             | Laos                 | 1 LAK = 220.99 INR |
| LBP             | Lebanon                 | 1 LBP = 909.60 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.03 INR |
...
| MGA             | Madagascar                 | 1 MGA = 47.23 INR |
...
| PYG             | Paraguay                 | 1 PYG = 80.12 INR |
| QAR             | Qatar                 | 1 QAR = 0.04 INR |
| RON             | Romania                 | 1 RON = 0.05 INR |
| RSD             | Serbia                 | 1 RSD = 1.15 INR |
| RUB             | Russia                 | 1 RUB = 1.00 INR |
| RWF             | Rwanda                 | 1 RWF = 14.42 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.42 INR |
| XPF             | CFP Franc                 | 1 XPF = 1.17 INR |
