...
## 📅 Last Updated: **2025-03-31 01:40:04 UTC**
...
| HUF             | Hungary                 | 1 HUF = 3.71 INR |
| IDR             | Indonesia                 | 1 IDR = 165.93 INR |
| ILS             | Israel                 | 1 ILS = 0.04 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.85 INR |
| IQD             | Iraq                 | 1 IQD = 12.96 INR |
| IRR             | Iran                 | 1 IRR = 421.00 INR |
| ISK             | Iceland                 | 1 ISK = 1.31 INR |
...
| KHR             | Cambodia                 | 1 KHR = 39.77 INR |
| KMF             | Comoros                 | 1 KMF = 4.56 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 14.69 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.99 INR |
| LAK             | Laos                 | 1 LAK = 214.41 INR |
| LBP             | Lebanon                 | 1 LBP = 886.58 INR |
| LKR             | Sri Lanka                 | 1 LKR = 2.93 INR |
| LRD             | Liberia                 | 1 LRD = 1.98 INR |
...
| MGA             | Madagascar                 | 1 MGA = 46.55 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.17 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 36.23 INR |
| UYU             | Uruguay                 | 1 UYU = 0.42 INR |
| UZS             | Uzbekistan                 | 1 UZS = 127.76 INR |
| VES             | Unknown Country                 | 1 VES = 0.69 INR |
| VND             | Vietnam                 | 1 VND = 255.75 INR |
