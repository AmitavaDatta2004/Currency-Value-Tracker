...
## 📅 Last Updated: **2025-06-24 01:47:04 UTC**
...
| HUF             | Hungary                 | 1 HUF = 3.47 INR |
| IDR             | Indonesia                 | 1 IDR = 163.85 INR |
| ILS             | Israel                 | 1 ILS = 0.03 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.86 INR |
| IQD             | Iraq                 | 1 IQD = 12.95 INR |
...
| KRW             | South Korea                 | 1 KRW = 13.67 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 5.16 INR |
| LAK             | Laos                 | 1 LAK = 213.19 INR |
| LBP             | Lebanon                 | 1 LBP = 885.46 INR |
...
| MGA             | Madagascar                 | 1 MGA = 43.94 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.95 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 35.66 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 123.50 INR |
| VES             | Unknown Country                 | 1 VES = 1.04 INR |
| VND             | Vietnam                 | 1 VND = 261.55 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.20 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.66 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.66 INR |
