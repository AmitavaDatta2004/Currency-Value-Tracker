...
## 📅 Last Updated: **2026-02-04 08:43:04 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 22.00 INR |
...
| COP             | Colombia                 | 1 COP = 36.30 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.95 INR |
...
| IDR             | Indonesia                 | 1 IDR = 167.75 INR |
| ILS             | Israel                 | 1 ILS = 0.03 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.90 INR |
| IQD             | Iraq                 | 1 IQD = 13.05 INR |
...
| KRW             | South Korea                 | 1 KRW = 14.53 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.99 INR |
| LAK             | Laos                 | 1 LAK = 214.28 INR |
| LBP             | Lebanon                 | 1 LBP = 892.10 INR |
...
| MGA             | Madagascar                 | 1 MGA = 44.15 INR |
...
| TZS             | Tanzania                 | 1 TZS = 25.87 INR |
| UAH             | Ukraine                 | 1 UAH = 0.43 INR |
| UGX             | Uganda                 | 1 UGX = 35.51 INR |
| UYU             | Uruguay                 | 1 UYU = 0.38 INR |
| UZS             | Uzbekistan                 | 1 UZS = 121.96 INR |
| VES             | Unknown Country                 | 1 VES = 3.72 INR |
| VND             | Vietnam                 | 1 VND = 259.89 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.20 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.54 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.54 INR |
