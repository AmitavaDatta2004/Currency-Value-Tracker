...
## 📅 Last Updated: **2026-02-14 16:32:07 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 22.55 INR |
| CHF             | Switzerland                 | 1 CHF = 0.01 INR |
| CLF             | Chile                 | 1 CLF = 0.00 INR |
| CLP             | Chile                 | 1 CLP = 8.63 INR |
| CNH             | China (Offshore Yuan)                 | 1 CNH = 0.07 INR |
| CNY             | China                 | 1 CNY = 0.07 INR |
| COP             | Colombia                 | 1 COP = 36.60 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.85 INR |
...
| HUF             | Hungary                 | 1 HUF = 3.19 INR |
| IDR             | Indonesia                 | 1 IDR = 168.33 INR |
...
| JPY             | Japan                 | 1 JPY = 1.53 INR |
| KES             | Kenya                 | 1 KES = 1.29 INR |
| KGS             | Kyrgyzstan                 | 1 KGS = 0.87 INR |
| KHR             | Cambodia                 | 1 KHR = 40.18 INR |
| KMF             | Comoros                 | 1 KMF = 4.15 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 14.41 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.94 INR |
| LAK             | Laos                 | 1 LAK = 214.38 INR |
| LBP             | Lebanon                 | 1 LBP = 894.57 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.09 INR |
| LRD             | Liberia                 | 1 LRD = 1.86 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.07 INR |
| UAH             | Ukraine                 | 1 UAH = 0.43 INR |
| UGX             | Uganda                 | 1 UGX = 35.36 INR |
| UYU             | Uruguay                 | 1 UYU = 0.39 INR |
| UZS             | Uzbekistan                 | 1 UZS = 122.77 INR |
| VES             | Unknown Country                 | 1 VES = 3.93 INR |
| VND             | Vietnam                 | 1 VND = 259.70 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.19 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.53 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.53 INR |
| XPF             | CFP Franc                 | 1 XPF = 1.00 INR |
| YER             | Yemen                 | 1 YER = 2.38 INR |
| ZAR             | South Africa                 | 1 ZAR = 0.16 INR |
| ZMK             | Zambia (Old Currency)                 | 1 ZMK = 90.01 INR |
| ZMW             | Zambia                 | 1 ZMW = 0.18 INR |
