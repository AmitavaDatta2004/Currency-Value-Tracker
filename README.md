...
## 📅 Last Updated: **2026-03-27 08:55:07 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 22.86 INR |
...
| LAK             | Laos                 | 1 LAK = 215.66 INR |
| LBP             | Lebanon                 | 1 LBP = 894.10 INR |
...
| MGA             | Madagascar                 | 1 MGA = 41.61 INR |
| MKD             | North Macedonia                 | 1 MKD = 0.53 INR |
| MMK             | Myanmar (Burma)                 | 1 MMK = 21.03 INR |
...
| TZS             | Tanzania                 | 1 TZS = 25.74 INR |
| UAH             | Ukraine                 | 1 UAH = 0.44 INR |
| UGX             | Uganda                 | 1 UGX = 37.14 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 121.62 INR |
| VES             | Unknown Country                 | 1 VES = 4.66 INR |
