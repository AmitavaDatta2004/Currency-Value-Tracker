...
| CLP             | Chile                 | 1 CLP = 10.00 INR |
| CNH             | China (Offshore Yuan)                 | 1 CNH = 0.07 INR |
| CNY             | China                 | 1 CNY = 0.07 INR |
| COP             | Colombia                 | 1 COP = 44.17 INR |
| CRC             | Costa Rica                 | 1 CRC = 5.14 INR |
...
| IDR             | Indonesia                 | 1 IDR = 169.51 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.79 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 36.91 INR |
| UYU             | Uruguay                 | 1 UYU = 0.43 INR |
| UZS             | Uzbekistan                 | 1 UZS = 129.51 INR |
| VES             | Unknown Country                 | 1 VES = 0.73 INR |
| VND             | Vietnam                 | 1 VND = 259.90 INR |
