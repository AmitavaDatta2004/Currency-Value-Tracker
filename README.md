...
## 📅 Last Updated: **2025-11-25 08:30:06 UTC**
...
| LAK             | Laos                 | 1 LAK = 217.70 INR |
| LBP             | Lebanon                 | 1 LBP = 897.87 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.09 INR |
| LRD             | Liberia                 | 1 LRD = 1.79 INR |
...
| TZS             | Tanzania                 | 1 TZS = 24.76 INR |
| UAH             | Ukraine                 | 1 UAH = 0.43 INR |
| UGX             | Uganda                 | 1 UGX = 36.34 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 120.20 INR |
| VES             | Unknown Country                 | 1 VES = 2.43 INR |
| VND             | Vietnam                 | 1 VND = 263.78 INR |
