...
## 📅 Last Updated: **2026-05-24 09:56:07 UTC**
...
| MGA             | Madagascar                 | 1 MGA = 41.97 INR |
...
| UGX             | Uganda                 | 1 UGX = 37.83 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 119.86 INR |
| VES             | Unknown Country                 | 1 VES = 5.26 INR |
| VND             | Vietnam                 | 1 VND = 263.65 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.17 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.65 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.65 INR |
