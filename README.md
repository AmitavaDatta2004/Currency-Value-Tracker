...
## 📅 Last Updated: **2026-07-15 02:33:05 UTC**
...
| KHR             | Cambodia                 | 1 KHR = 40.43 INR |
| KMF             | Comoros                 | 1 KMF = 4.31 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 14.90 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.67 INR |
| LAK             | Laos                 | 1 LAK = 224.90 INR |
| LBP             | Lebanon                 | 1 LBP = 892.20 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.40 INR |
| UAH             | Ukraine                 | 1 UAH = 0.45 INR |
| UGX             | Uganda                 | 1 UGX = 36.93 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 120.26 INR |
| VES             | Unknown Country                 | 1 VES = 7.23 INR |
| VND             | Vietnam                 | 1 VND = 262.69 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.20 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.74 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.74 INR |
