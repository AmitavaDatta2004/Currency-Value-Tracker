...
## 📅 Last Updated: **2026-02-19 08:49:09 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 22.75 INR |
| CHF             | Switzerland                 | 1 CHF = 0.01 INR |
| CLF             | Chile                 | 1 CLF = 0.00 INR |
| CLP             | Chile                 | 1 CLP = 8.62 INR |
| CNH             | China (Offshore Yuan)                 | 1 CNH = 0.07 INR |
| CNY             | China                 | 1 CNY = 0.07 INR |
| COP             | Colombia                 | 1 COP = 36.80 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.84 INR |
...
| IDR             | Indonesia                 | 1 IDR = 168.95 INR |
...
| KZT             | Kazakhstan                 | 1 KZT = 4.91 INR |
| LAK             | Laos                 | 1 LAK = 214.99 INR |
| LBP             | Lebanon                 | 1 LBP = 898.55 INR |
...
| MGA             | Madagascar                 | 1 MGA = 43.66 INR |
...
| TZS             | Tanzania                 | 1 TZS = 25.81 INR |
| UAH             | Ukraine                 | 1 UAH = 0.43 INR |
| UGX             | Uganda                 | 1 UGX = 35.52 INR |
| UYU             | Uruguay                 | 1 UYU = 0.39 INR |
| UZS             | Uzbekistan                 | 1 UZS = 121.79 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.56 INR |
