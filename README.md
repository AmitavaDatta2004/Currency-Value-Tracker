...
## 📅 Last Updated: **2026-09-12 18:10:05 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 23.07 INR |
...
| IDR             | Indonesia                 | 1 IDR = 176.07 INR |
...
| KZT             | Kazakhstan                 | 1 KZT = 4.51 INR |
| LAK             | Laos                 | 1 LAK = 223.42 INR |
| LBP             | Lebanon                 | 1 LBP = 894.25 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.28 INR |
| LRD             | Liberia                 | 1 LRD = 1.74 INR |
...
| MGA             | Madagascar                 | 1 MGA = 42.99 INR |
...
| SSP             | Unknown Country                 | 1 SSP = 56.49 INR |
...
| UGX             | Uganda                 | 1 UGX = 38.64 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 117.43 INR |
| VES             | Unknown Country                 | 1 VES = 8.31 INR |
| VND             | Vietnam                 | 1 VND = 259.23 INR |
