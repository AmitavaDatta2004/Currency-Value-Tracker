...
## 📅 Last Updated: **2026-04-13 09:56:04 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 23.00 INR |
| CHF             | Switzerland                 | 1 CHF = 0.01 INR |
| CLF             | Chile                 | 1 CLF = 0.00 INR |
| CLP             | Chile                 | 1 CLP = 8.96 INR |
| CNH             | China (Offshore Yuan)                 | 1 CNH = 0.07 INR |
| CNY             | China                 | 1 CNY = 0.07 INR |
| COP             | Colombia                 | 1 COP = 36.50 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.64 INR |
...
| MGA             | Madagascar                 | 1 MGA = 41.58 INR |
...
| UGX             | Uganda                 | 1 UGX = 37.07 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 121.83 INR |
| VES             | Unknown Country                 | 1 VES = 4.76 INR |
| VND             | Vietnam                 | 1 VND = 263.44 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.19 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.61 INR |
