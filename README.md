...
## 📅 Last Updated: **2025-03-30 16:21:12 UTC**
...
| KHR             | Cambodia                 | 1 KHR = 39.97 INR |
| KMF             | Comoros                 | 1 KMF = 4.54 INR |
...
| LAK             | Laos                 | 1 LAK = 216.51 INR |
| LBP             | Lebanon                 | 1 LBP = 895.33 INR |
| LKR             | Sri Lanka                 | 1 LKR = 2.96 INR |
...
| MGA             | Madagascar                 | 1 MGA = 46.51 INR |
...
| TMT             | Turkmenistan                 | 1 TMT = 0.03 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.15 INR |
| UAH             | Ukraine                 | 1 UAH = 0.42 INR |
| UGX             | Uganda                 | 1 UGX = 36.65 INR |
| UYU             | Uruguay                 | 1 UYU = 0.42 INR |
| UZS             | Uzbekistan                 | 1 UZS = 129.12 INR |
| VES             | Unknown Country                 | 1 VES = 0.69 INR |
| VND             | Vietnam                 | 1 VND = 255.55 INR |
