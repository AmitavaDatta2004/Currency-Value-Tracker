...
## 📅 Last Updated: **2026-01-27 08:35:04 UTC**
...
| IDR             | Indonesia                 | 1 IDR = 167.68 INR |
...
| KRW             | South Korea                 | 1 KRW = 14.48 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 5.02 INR |
| LAK             | Laos                 | 1 LAK = 215.32 INR |
...
| MGA             | Madagascar                 | 1 MGA = 45.05 INR |
...
| TZS             | Tanzania                 | 1 TZS = 25.50 INR |
| UAH             | Ukraine                 | 1 UAH = 0.43 INR |
| UGX             | Uganda                 | 1 UGX = 35.38 INR |
| UYU             | Uruguay                 | 1 UYU = 0.37 INR |
| UZS             | Uzbekistan                 | 1 UZS = 121.15 INR |
| VES             | Unknown Country                 | 1 VES = 3.58 INR |
| VND             | Vietnam                 | 1 VND = 261.36 INR |
