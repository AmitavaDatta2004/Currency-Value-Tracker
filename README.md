...
## 📅 Last Updated: **2025-05-26 01:45:05 UTC**
...
| HUF             | Hungary                 | 1 HUF = 3.54 INR |
| IDR             | Indonesia                 | 1 IDR = 161.96 INR |
...
| LAK             | Laos                 | 1 LAK = 215.12 INR |
| LBP             | Lebanon                 | 1 LBP = 892.15 INR |
...
| MGA             | Madagascar                 | 1 MGA = 44.53 INR |
...
| PHP             | Philippines                 | 1 PHP = 0.55 INR |
| PKR             | Pakistan                 | 1 PKR = 2.81 INR |
| PLN             | Poland                 | 1 PLN = 0.04 INR |
| PYG             | Paraguay                 | 1 PYG = 79.45 INR |
...
| UGX             | Uganda                 | 1 UGX = 36.35 INR |
| UYU             | Uruguay                 | 1 UYU = 0.41 INR |
| UZS             | Uzbekistan                 | 1 UZS = 128.49 INR |
| VES             | Unknown Country                 | 1 VES = 0.95 INR |
| VND             | Vietnam                 | 1 VND = 259.61 INR |
