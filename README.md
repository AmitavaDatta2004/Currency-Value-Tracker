...
## 📅 Last Updated: **2025-03-06 08:24:04 UTC**
...
| BDT             | Bangladesh                 | 1 BDT = 1.20 INR |
| BGN             | Bulgaria                 | 1 BGN = 0.02 INR |
| BHD             | Bahrain                 | 1 BHD = 0.00 INR |
| BIF             | Burundi                 | 1 BIF = 29.25 INR |
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 28.76 INR |
...
| HUF             | Hungary                 | 1 HUF = 3.69 INR |
| IDR             | Indonesia                 | 1 IDR = 163.58 INR |
| ILS             | Israel                 | 1 ILS = 0.04 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.87 INR |
| IQD             | Iraq                 | 1 IQD = 12.93 INR |
| IRR             | Iran                 | 1 IRR = 421.13 INR |
| ISK             | Iceland                 | 1 ISK = 1.36 INR |
| JEP             | Jersey                 | 1 JEP = 0.01 INR |
| JMD             | Jamaica                 | 1 JMD = 1.55 INR |
| JOD             | Jordan                 | 1 JOD = 0.01 INR |
| JPY             | Japan                 | 1 JPY = 1.48 INR |
| KES             | Kenya                 | 1 KES = 1.29 INR |
| KGS             | Kyrgyzstan                 | 1 KGS = 0.87 INR |
| KHR             | Cambodia                 | 1 KHR = 39.60 INR |
| KMF             | Comoros                 | 1 KMF = 4.62 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 14.45 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.90 INR |
| LAK             | Laos                 | 1 LAK = 214.13 INR |
| LBP             | Lebanon                 | 1 LBP = 884.70 INR |
| LKR             | Sri Lanka                 | 1 LKR = 2.92 INR |
...
| PKR             | Pakistan                 | 1 PKR = 2.76 INR |
| PLN             | Poland                 | 1 PLN = 0.04 INR |
| PYG             | Paraguay                 | 1 PYG = 78.19 INR |
| QAR             | Qatar                 | 1 QAR = 0.04 INR |
| RON             | Romania                 | 1 RON = 0.05 INR |
| RSD             | Serbia                 | 1 RSD = 1.08 INR |
| RUB             | Russia                 | 1 RUB = 0.90 INR |
| RWF             | Rwanda                 | 1 RWF = 14.15 INR |
...
| SOS             | Somalia                 | 1 SOS = 5.64 INR |
| SRD             | Suriname                 | 1 SRD = 0.36 INR |
...
| UGX             | Uganda                 | 1 UGX = 36.25 INR |
| UYU             | Uruguay                 | 1 UYU = 0.42 INR |
| UZS             | Uzbekistan                 | 1 UZS = 127.38 INR |
| VES             | Unknown Country                 | 1 VES = 0.64 INR |
| VND             | Vietnam                 | 1 VND = 254.85 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.25 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 6.07 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.07 INR |
| XPF             | CFP Franc                 | 1 XPF = 1.10 INR |
| YER             | Yemen                 | 1 YER = 2.47 INR |
