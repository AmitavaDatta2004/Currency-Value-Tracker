...
## 📅 Last Updated: **2025-06-09 08:29:15 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 28.80 INR |
...
| HUF             | Hungary                 | 1 HUF = 3.53 INR |
| IDR             | Indonesia                 | 1 IDR = 162.78 INR |
...
| KRW             | South Korea                 | 1 KRW = 13.52 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 5.11 INR |
| LAK             | Laos                 | 1 LAK = 216.26 INR |
| LBP             | Lebanon                 | 1 LBP = 897.51 INR |
...
| MGA             | Madagascar                 | 1 MGA = 45.19 INR |
...
| UGX             | Uganda                 | 1 UGX = 36.26 INR |
| UYU             | Uruguay                 | 1 UYU = 0.42 INR |
| UZS             | Uzbekistan                 | 1 UZS = 127.99 INR |
| VES             | Unknown Country                 | 1 VES = 0.98 INR |
| VND             | Vietnam                 | 1 VND = 260.40 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.20 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.75 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.75 INR |
