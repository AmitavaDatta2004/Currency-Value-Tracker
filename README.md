...
## 📅 Last Updated: **2026-02-12 08:50:09 UTC**
...
| HUF             | Hungary                 | 1 HUF = 3.21 INR |
| IDR             | Indonesia                 | 1 IDR = 168.24 INR |
| ILS             | Israel                 | 1 ILS = 0.03 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.91 INR |
| IQD             | Iraq                 | 1 IQD = 13.13 INR |
...
| KHR             | Cambodia                 | 1 KHR = 40.38 INR |
| KMF             | Comoros                 | 1 KMF = 4.15 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 14.38 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.95 INR |
| LAK             | Laos                 | 1 LAK = 215.23 INR |
| LBP             | Lebanon                 | 1 LBP = 895.32 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.10 INR |
| LRD             | Liberia                 | 1 LRD = 1.87 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.01 INR |
| UAH             | Ukraine                 | 1 UAH = 0.43 INR |
| UGX             | Uganda                 | 1 UGX = 35.43 INR |
| UYU             | Uruguay                 | 1 UYU = 0.38 INR |
| UZS             | Uzbekistan                 | 1 UZS = 123.49 INR |
| VES             | Unknown Country                 | 1 VES = 3.88 INR |
| VND             | Vietnam                 | 1 VND = 259.63 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.19 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.52 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.52 INR |
