...
| COP             | Colombia                 | 1 COP = 30.53 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.45 INR |
...
| KRW             | South Korea                 | 1 KRW = 13.94 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.59 INR |
| LAK             | Laos                 | 1 LAK = 223.90 INR |
| LBP             | Lebanon                 | 1 LBP = 890.30 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.29 INR |
...
| MGA             | Madagascar                 | 1 MGA = 42.85 INR |
...
| UGX             | Uganda                 | 1 UGX = 37.08 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 117.32 INR |
| VES             | Unknown Country                 | 1 VES = 7.76 INR |
| VND             | Vietnam                 | 1 VND = 261.81 INR |
