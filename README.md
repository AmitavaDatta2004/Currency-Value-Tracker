...
## 📅 Last Updated: **2026-07-30 10:24:05 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 22.85 INR |
...
| IDR             | Indonesia                 | 1 IDR = 180.81 INR |
| ILS             | Israel                 | 1 ILS = 0.03 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.96 INR |
| IQD             | Iraq                 | 1 IQD = 13.02 INR |
| IRR             | Iran                 | 1 IRR = 13752.50 INR |
| ISK             | Iceland                 | 1 ISK = 1.24 INR |
| JEP             | Jersey                 | 1 JEP = 0.01 INR |
| JMD             | Jamaica                 | 1 JMD = 1.57 INR |
| JOD             | Jordan                 | 1 JOD = 0.01 INR |
| JPY             | Japan                 | 1 JPY = 1.63 INR |
| KES             | Kenya                 | 1 KES = 1.29 INR |
| KGS             | Kyrgyzstan                 | 1 KGS = 0.87 INR |
| KHR             | Cambodia                 | 1 KHR = 40.17 INR |
| KMF             | Comoros                 | 1 KMF = 4.30 INR |
| KRW             | South Korea                 | 1 KRW = 14.35 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.74 INR |
| LAK             | Laos                 | 1 LAK = 225.32 INR |
| LBP             | Lebanon                 | 1 LBP = 889.83 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.34 INR |
| LRD             | Liberia                 | 1 LRD = 1.80 INR |
...
| MGA             | Madagascar                 | 1 MGA = 42.95 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.47 INR |
| UAH             | Ukraine                 | 1 UAH = 0.45 INR |
| UGX             | Uganda                 | 1 UGX = 37.11 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 119.61 INR |
| VES             | Unknown Country                 | 1 VES = 7.43 INR |
| VND             | Vietnam                 | 1 VND = 262.81 INR |
