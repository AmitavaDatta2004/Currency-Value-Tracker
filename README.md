...
## 📅 Last Updated: **2025-02-03 08:23:17 UTC**

| 🌍 **Currency** | 🏳️ **Country**           | 💰 **Exchange Rate**        |
|-----------------|--------------------------|-----------------------------|
| AED             | United Arab Emirates                 | 1 AED = 0.04 INR |
| AFN             | Afghanistan                 | 1 AFN = 0.77 INR |
| ALL             | Albania                 | 1 ALL = 0.97 INR |
| AMD             | Armenia                 | 1 AMD = 4.05 INR |
| ANG             | Netherlands Antilles                 | 1 ANG = 0.02 INR |
| AOA             | Angola                 | 1 AOA = 4.56 INR |
...
| CLP             | Chile                 | 1 CLP = 9.99 INR |
| CNH             | China (Offshore Yuan)                 | 1 CNH = 0.07 INR |
| CNY             | China                 | 1 CNY = 0.07 INR |
| COP             | Colombia                 | 1 COP = 42.14 INR |
| CRC             | Costa Rica                 | 1 CRC = 5.11 INR |
| CUC             | Cuba (Convertible Peso)                 | 1 CUC = 0.01 INR |
| CUP             | Cuba                 | 1 CUP = 0.27 INR |
| CVE             | Cape Verde                 | 1 CVE = 1.08 INR |
| CZK             | Czech Republic                 | 1 CZK = 0.25 INR |
| DJF             | Djibouti                 | 1 DJF = 1.80 INR |
| DKK             | Denmark                 | 1 DKK = 0.07 INR |
| DOP             | Dominican Republic                 | 1 DOP = 0.63 INR |
| DZD             | Algeria                 | 1 DZD = 1.36 INR |
...
| KHR             | Cambodia                 | 1 KHR = 40.78 INR |
| KMF             | Comoros                 | 1 KMF = 4.73 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 14.66 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 5.25 INR |
| LAK             | Laos                 | 1 LAK = 220.49 INR |
| LBP             | Lebanon                 | 1 LBP = 907.56 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.02 INR |
| LRD             | Liberia                 | 1 LRD = 2.02 INR |
...
| PYG             | Paraguay                 | 1 PYG = 79.94 INR |
| QAR             | Qatar                 | 1 QAR = 0.04 INR |
| RON             | Romania                 | 1 RON = 0.05 INR |
| RSD             | Serbia                 | 1 RSD = 1.14 INR |
| RUB             | Russia                 | 1 RUB = 1.00 INR |
| RWF             | Rwanda                 | 1 RWF = 14.39 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.41 INR |
| XPF             | CFP Franc                 | 1 XPF = 1.16 INR |
