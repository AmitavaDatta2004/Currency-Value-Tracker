...
## 📅 Last Updated: **2026-01-29 08:41:04 UTC**
...
| COP             | Colombia                 | 1 COP = 36.70 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.97 INR |
...
| IDR             | Indonesia                 | 1 IDR = 167.58 INR |
...
| KRW             | South Korea                 | 1 KRW = 14.32 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 5.04 INR |
| LAK             | Laos                 | 1 LAK = 215.56 INR |
| LBP             | Lebanon                 | 1 LBP = 895.99 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.10 INR |
| LRD             | Liberia                 | 1 LRD = 1.85 INR |
...
| MGA             | Madagascar                 | 1 MGA = 44.64 INR |
...
| TZS             | Tanzania                 | 1 TZS = 25.60 INR |
| UAH             | Ukraine                 | 1 UAH = 0.43 INR |
| UGX             | Uganda                 | 1 UGX = 35.82 INR |
| UYU             | Uruguay                 | 1 UYU = 0.38 INR |
| UZS             | Uzbekistan                 | 1 UZS = 121.06 INR |
| VES             | Unknown Country                 | 1 VES = 3.58 INR |
| VND             | Vietnam                 | 1 VND = 260.12 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.20 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.48 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.48 INR |
