...
## 📅 Last Updated: **2026-07-23 10:23:08 UTC**
...
| CLP             | Chile                 | 1 CLP = 9.36 INR |
| CNH             | China (Offshore Yuan)                 | 1 CNH = 0.07 INR |
| CNY             | China                 | 1 CNY = 0.07 INR |
| COP             | Colombia                 | 1 COP = 32.18 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.53 INR |
...
| KZT             | Kazakhstan                 | 1 KZT = 4.66 INR |
| LAK             | Laos                 | 1 LAK = 225.69 INR |
| LBP             | Lebanon                 | 1 LBP = 893.45 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.36 INR |
...
| UGX             | Uganda                 | 1 UGX = 37.31 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 120.24 INR |
| VES             | Unknown Country                 | 1 VES = 7.37 INR |
| VND             | Vietnam                 | 1 VND = 263.17 INR |
