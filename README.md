...
## 📅 Last Updated: **2025-09-09 01:36:07 UTC**
...
| IDR             | Indonesia                 | 1 IDR = 165.03 INR |
...
| KRW             | South Korea                 | 1 KRW = 13.87 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 5.33 INR |
| LAK             | Laos                 | 1 LAK = 216.32 INR |
| LBP             | Lebanon                 | 1 LBP = 892.69 INR |
...
| MGA             | Madagascar                 | 1 MGA = 44.78 INR |
...
| TZS             | Tanzania                 | 1 TZS = 24.99 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 35.08 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 124.50 INR |
| VES             | Unknown Country                 | 1 VES = 1.54 INR |
| VND             | Vietnam                 | 1 VND = 264.13 INR |
