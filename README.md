...
## 📅 Last Updated: **2026-05-08 09:23:07 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 23.16 INR |
| CHF             | Switzerland                 | 1 CHF = 0.01 INR |
| CLF             | Chile                 | 1 CLF = 0.00 INR |
| CLP             | Chile                 | 1 CLP = 8.91 INR |
| CNH             | China (Offshore Yuan)                 | 1 CNH = 0.07 INR |
| CNY             | China                 | 1 CNY = 0.07 INR |
| COP             | Colombia                 | 1 COP = 37.39 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.60 INR |
...
| HUF             | Hungary                 | 1 HUF = 3.02 INR |
| IDR             | Indonesia                 | 1 IDR = 173.59 INR |
| ILS             | Israel                 | 1 ILS = 0.03 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.94 INR |
| IQD             | Iraq                 | 1 IQD = 13.14 INR |
| IRR             | Iran                 | 1 IRR = 13129.00 INR |
...
| KRW             | South Korea                 | 1 KRW = 14.65 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.65 INR |
| LAK             | Laos                 | 1 LAK = 220.16 INR |
| LBP             | Lebanon                 | 1 LBP = 895.34 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.23 INR |
...
| TRY             | Turkey                 | 1 TRY = 0.45 INR |
| TTD             | Trinidad and Tobago                 | 1 TTD = 0.07 INR |
| TWD             | Taiwan                 | 1 TWD = 0.31 INR |
| TZS             | Tanzania                 | 1 TZS = 26.05 INR |
| UAH             | Ukraine                 | 1 UAH = 0.44 INR |
| UGX             | Uganda                 | 1 UGX = 37.52 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 121.57 INR |
| VES             | Unknown Country                 | 1 VES = 4.96 INR |
| VND             | Vietnam                 | 1 VND = 263.08 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.18 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.59 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.59 INR |
