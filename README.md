...
## 📅 Last Updated: **2025-06-20 08:27:04 UTC**
...
| IDR             | Indonesia                 | 1 IDR = 164.01 INR |
...
| KRW             | South Korea                 | 1 KRW = 13.69 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 5.20 INR |
...
| MGA             | Madagascar                 | 1 MGA = 44.35 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.44 INR |
| UAH             | Ukraine                 | 1 UAH = 0.42 INR |
| UGX             | Uganda                 | 1 UGX = 36.02 INR |
| UYU             | Uruguay                 | 1 UYU = 0.41 INR |
| UZS             | Uzbekistan                 | 1 UZS = 126.60 INR |
| VES             | Unknown Country                 | 1 VES = 1.03 INR |
| VND             | Vietnam                 | 1 VND = 261.24 INR |
