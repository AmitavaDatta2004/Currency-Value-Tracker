...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 28.55 INR |
...
| HUF             | Hungary                 | 1 HUF = 3.93 INR |
| IDR             | Indonesia                 | 1 IDR = 163.60 INR |
...
| MGA             | Madagascar                 | 1 MGA = 47.44 INR |
...
| UZS             | Uzbekistan                 | 1 UZS = 130.45 INR |
| VES             | Unknown Country                 | 1 VES = 0.60 INR |
| VND             | Vietnam                 | 1 VND = 253.78 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.19 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 6.36 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.36 INR |
