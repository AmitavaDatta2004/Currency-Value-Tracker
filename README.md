...
| HTG             | Haiti                 | 1 HTG = 1.29 INR |
| HUF             | Hungary                 | 1 HUF = 3.44 INR |
| IDR             | Indonesia                 | 1 IDR = 163.96 INR |
| ILS             | Israel                 | 1 ILS = 0.03 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.87 INR |
| IQD             | Iraq                 | 1 IQD = 12.94 INR |
...
| KHR             | Cambodia                 | 1 KHR = 39.57 INR |
| KMF             | Comoros                 | 1 KMF = 4.27 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 13.84 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 5.36 INR |
| LAK             | Laos                 | 1 LAK = 213.55 INR |
| LBP             | Lebanon                 | 1 LBP = 884.85 INR |
...
| TRY             | Turkey                 | 1 TRY = 0.41 INR |
| TTD             | Trinidad and Tobago                 | 1 TTD = 0.07 INR |
| TWD             | Taiwan                 | 1 TWD = 0.30 INR |
| TZS             | Tanzania                 | 1 TZS = 25.21 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 35.40 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 125.34 INR |
| VES             | Unknown Country                 | 1 VES = 1.23 INR |
| VND             | Vietnam                 | 1 VND = 261.86 INR |
