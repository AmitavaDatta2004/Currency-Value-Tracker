...
## 📅 Last Updated: **2026-03-12 08:46:03 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 21.78 INR |
...
| COP             | Colombia                 | 1 COP = 37.05 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.73 INR |
...
| MGA             | Madagascar                 | 1 MGA = 41.62 INR |
...
| PYG             | Paraguay                 | 1 PYG = 65.06 INR |
| QAR             | Qatar                 | 1 QAR = 0.04 INR |
| RON             | Romania                 | 1 RON = 0.04 INR |
| RSD             | Serbia                 | 1 RSD = 1.02 INR |
| RUB             | Russia                 | 1 RUB = 0.79 INR |
| RWF             | Rwanda                 | 1 RWF = 14.67 INR |
...
| UGX             | Uganda                 | 1 UGX = 37.09 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 121.94 INR |
| VES             | Unknown Country                 | 1 VES = 4.38 INR |
| VND             | Vietnam                 | 1 VND = 262.65 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.20 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.68 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.68 INR |
