...
## 📅 Last Updated: **2025-03-01 16:20:12 UTC**
...
| LAK             | Laos                 | 1 LAK = 217.39 INR |
| LBP             | Lebanon                 | 1 LBP = 898.61 INR |
...
| MGA             | Madagascar                 | 1 MGA = 47.16 INR |
...
| UGX             | Uganda                 | 1 UGX = 36.76 INR |
| UYU             | Uruguay                 | 1 UYU = 0.42 INR |
| UZS             | Uzbekistan                 | 1 UZS = 129.31 INR |
| VES             | Unknown Country                 | 1 VES = 0.64 INR |
| VND             | Vietnam                 | 1 VND = 255.34 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.24 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 6.31 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.31 INR |
