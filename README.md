...
## 📅 Last Updated: **2025-03-07 08:23:04 UTC**
...
| IDR             | Indonesia                 | 1 IDR = 162.76 INR |
...
| LAK             | Laos                 | 1 LAK = 216.86 INR |
| LBP             | Lebanon                 | 1 LBP = 896.80 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.38 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 36.77 INR |
| UYU             | Uruguay                 | 1 UYU = 0.43 INR |
| UZS             | Uzbekistan                 | 1 UZS = 129.30 INR |
| VES             | Unknown Country                 | 1 VES = 0.64 INR |
| VND             | Vietnam                 | 1 VND = 255.25 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.24 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 6.08 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.08 INR |
