...
## 📅 Last Updated: **2025-03-31 08:27:04 UTC**

| 🌍 **Currency** | 🏳️ **Country**           | 💰 **Exchange Rate**        |
|-----------------|--------------------------|-----------------------------|
| AED             | United Arab Emirates                 | 1 AED = 0.04 INR |
| AFN             | Afghanistan                 | 1 AFN = 0.70 INR |
| ALL             | Albania                 | 1 ALL = 0.92 INR |
| AMD             | Armenia                 | 1 AMD = 3.88 INR |
| ANG             | Netherlands Antilles                 | 1 ANG = 0.02 INR |
| AOA             | Angola                 | 1 AOA = 9.15 INR |
| ARS             | Argentina                 | 1 ARS = 10.71 INR |
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 28.72 INR |
| CHF             | Switzerland                 | 1 CHF = 0.01 INR |
| CLF             | Chile                 | 1 CLF = 0.00 INR |
| CLP             | Chile                 | 1 CLP = 9.33 INR |
| CNH             | China (Offshore Yuan)                 | 1 CNH = 0.07 INR |
| CNY             | China                 | 1 CNY = 0.07 INR |
| COP             | Colombia                 | 1 COP = 41.43 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.96 INR |
| CUC             | Cuba (Convertible Peso)                 | 1 CUC = 0.01 INR |
| CUP             | Cuba                 | 1 CUP = 0.27 INR |
| CVE             | Cape Verde                 | 1 CVE = 1.02 INR |
| CZK             | Czech Republic                 | 1 CZK = 0.23 INR |
...
| HUF             | Hungary                 | 1 HUF = 3.72 INR |
| IDR             | Indonesia                 | 1 IDR = 165.89 INR |
| ILS             | Israel                 | 1 ILS = 0.04 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.85 INR |
| IQD             | Iraq                 | 1 IQD = 13.01 INR |
| IRR             | Iran                 | 1 IRR = 421.00 INR |
| ISK             | Iceland                 | 1 ISK = 1.32 INR |
...
| KGS             | Kyrgyzstan                 | 1 KGS = 0.86 INR |
| KHR             | Cambodia                 | 1 KHR = 39.76 INR |
| KMF             | Comoros                 | 1 KMF = 4.56 INR |
...
| LAK             | Laos                 | 1 LAK = 215.19 INR |
| LBP             | Lebanon                 | 1 LBP = 889.81 INR |
| LKR             | Sri Lanka                 | 1 LKR = 2.94 INR |
| LRD             | Liberia                 | 1 LRD = 1.99 INR |
| LSL             | Lesotho                 | 1 LSL = 0.18 INR |
...
| SZL             | Swaziland                 | 1 SZL = 0.18 INR |
| THB             | Thailand                 | 1 THB = 0.34 INR |
| TJS             | Tajikistan                 | 1 TJS = 0.11 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.28 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 36.36 INR |
| UYU             | Uruguay                 | 1 UYU = 0.42 INR |
| UZS             | Uzbekistan                 | 1 UZS = 128.23 INR |
| VES             | Unknown Country                 | 1 VES = 0.69 INR |
| VND             | Vietnam                 | 1 VND = 255.60 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.23 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 6.05 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.05 INR |
| XPF             | CFP Franc                 | 1 XPF = 1.10 INR |
| YER             | Yemen                 | 1 YER = 2.46 INR |
