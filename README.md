...
## 📅 Last Updated: **2026-01-23 08:32:08 UTC**
...
| CLP             | Chile                 | 1 CLP = 8.72 INR |
| CNH             | China (Offshore Yuan)                 | 1 CNH = 0.07 INR |
| CNY             | China                 | 1 CNY = 0.07 INR |
| COP             | Colombia                 | 1 COP = 36.00 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.92 INR |
...
| IDR             | Indonesia                 | 1 IDR = 168.48 INR |
...
| LAK             | Laos                 | 1 LAK = 215.22 INR |
| LBP             | Lebanon                 | 1 LBP = 891.94 INR |
...
| MGA             | Madagascar                 | 1 MGA = 45.96 INR |
...
| UGX             | Uganda                 | 1 UGX = 34.94 INR |
| UYU             | Uruguay                 | 1 UYU = 0.38 INR |
| UZS             | Uzbekistan                 | 1 UZS = 121.35 INR |
| VES             | Unknown Country                 | 1 VES = 3.52 INR |
| VND             | Vietnam                 | 1 VND = 262.41 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.20 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.58 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.58 INR |
