...
## 📅 Last Updated: **2025-03-06 01:25:12 UTC**
...
| HUF             | Hungary                 | 1 HUF = 3.79 INR |
| IDR             | Indonesia                 | 1 IDR = 164.20 INR |
| ILS             | Israel                 | 1 ILS = 0.04 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.87 INR |
| IQD             | Iraq                 | 1 IQD = 13.09 INR |
| IRR             | Iran                 | 1 IRR = 420.96 INR |
| ISK             | Iceland                 | 1 ISK = 1.39 INR |
...
| KHR             | Cambodia                 | 1 KHR = 40.26 INR |
| KMF             | Comoros                 | 1 KMF = 4.67 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 14.59 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.99 INR |
| LAK             | Laos                 | 1 LAK = 216.83 INR |
| LBP             | Lebanon                 | 1 LBP = 897.29 INR |
...
| MGA             | Madagascar                 | 1 MGA = 47.10 INR |
| MKD             | North Macedonia                 | 1 MKD = 0.58 INR |
...
| PYG             | Paraguay                 | 1 PYG = 79.18 INR |
| QAR             | Qatar                 | 1 QAR = 0.04 INR |
| RON             | Romania                 | 1 RON = 0.05 INR |
| RSD             | Serbia                 | 1 RSD = 1.11 INR |
...
| UGX             | Uganda                 | 1 UGX = 36.75 INR |
| UYU             | Uruguay                 | 1 UYU = 0.43 INR |
| UZS             | Uzbekistan                 | 1 UZS = 129.18 INR |
| VES             | Unknown Country                 | 1 VES = 0.64 INR |
| VND             | Vietnam                 | 1 VND = 255.58 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.25 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 6.23 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.23 INR |
| XPF             | CFP Franc                 | 1 XPF = 1.13 INR |
