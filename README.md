...
## 📅 Last Updated: **2026-02-13 08:45:07 UTC**
...
| CLP             | Chile                 | 1 CLP = 8.57 INR |
| CNH             | China (Offshore Yuan)                 | 1 CNH = 0.07 INR |
| CNY             | China                 | 1 CNY = 0.07 INR |
| COP             | Colombia                 | 1 COP = 36.69 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.88 INR |
...
| KHR             | Cambodia                 | 1 KHR = 40.30 INR |
| KMF             | Comoros                 | 1 KMF = 4.16 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 14.45 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.96 INR |
| LAK             | Laos                 | 1 LAK = 214.78 INR |
| LBP             | Lebanon                 | 1 LBP = 895.35 INR |
...
| MGA             | Madagascar                 | 1 MGA = 44.22 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.08 INR |
| UAH             | Ukraine                 | 1 UAH = 0.43 INR |
| UGX             | Uganda                 | 1 UGX = 35.45 INR |
| UYU             | Uruguay                 | 1 UYU = 0.38 INR |
| UZS             | Uzbekistan                 | 1 UZS = 123.29 INR |
| VES             | Unknown Country                 | 1 VES = 3.90 INR |
