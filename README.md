...
## 📅 Last Updated: **2025-04-07 01:38:04 UTC**
...
| KHR             | Cambodia                 | 1 KHR = 40.28 INR |
| KMF             | Comoros                 | 1 KMF = 4.50 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 14.67 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 5.10 INR |
| LAK             | Laos                 | 1 LAK = 217.94 INR |
| LBP             | Lebanon                 | 1 LBP = 901.56 INR |
| LKR             | Sri Lanka                 | 1 LKR = 2.98 INR |
...
| PYG             | Paraguay                 | 1 PYG = 80.67 INR |
| QAR             | Qatar                 | 1 QAR = 0.04 INR |
| RON             | Romania                 | 1 RON = 0.05 INR |
| RSD             | Serbia                 | 1 RSD = 1.07 INR |
| RUB             | Russia                 | 1 RUB = 0.85 INR |
| RWF             | Rwanda                 | 1 RWF = 14.50 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.92 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 36.78 INR |
| UYU             | Uruguay                 | 1 UYU = 0.43 INR |
| UZS             | Uzbekistan                 | 1 UZS = 130.01 INR |
| VES             | Unknown Country                 | 1 VES = 0.70 INR |
| VND             | Vietnam                 | 1 VND = 258.00 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.22 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.98 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.98 INR |
| XPF             | CFP Franc                 | 1 XPF = 1.09 INR |
