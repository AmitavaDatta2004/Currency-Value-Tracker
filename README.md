...
## 📅 Last Updated: **2025-08-24 01:49:17 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 28.66 INR |
...
| IDR             | Indonesia                 | 1 IDR = 162.34 INR |
...
| KZT             | Kazakhstan                 | 1 KZT = 5.32 INR |
| LAK             | Laos                 | 1 LAK = 214.33 INR |
| LBP             | Lebanon                 | 1 LBP = 889.99 INR |
...
| MGA             | Madagascar                 | 1 MGA = 43.80 INR |
...
| TZS             | Tanzania                 | 1 TZS = 24.68 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 35.24 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 122.78 INR |
| VES             | Unknown Country                 | 1 VES = 1.38 INR |
| VND             | Vietnam                 | 1 VND = 263.50 INR |
