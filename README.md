...
## 📅 Last Updated: **2026-03-19 02:27:07 UTC**
...
| IDR             | Indonesia                 | 1 IDR = 169.64 INR |
...
| KRW             | South Korea                 | 1 KRW = 14.97 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.85 INR |
| LAK             | Laos                 | 1 LAK = 215.91 INR |
| LBP             | Lebanon                 | 1 LBP = 901.21 INR |
...
| MGA             | Madagascar                 | 1 MGA = 41.91 INR |
...
| UGX             | Uganda                 | 1 UGX = 37.85 INR |
| UYU             | Uruguay                 | 1 UYU = 0.41 INR |
| UZS             | Uzbekistan                 | 1 UZS = 122.70 INR |
| VES             | Unknown Country                 | 1 VES = 4.51 INR |
| VND             | Vietnam                 | 1 VND = 263.16 INR |
