...
## 📅 Last Updated: **2026-01-20 08:34:04 UTC**
...
| CLP             | Chile                 | 1 CLP = 8.88 INR |
| CNH             | China (Offshore Yuan)                 | 1 CNH = 0.07 INR |
| CNY             | China                 | 1 CNY = 0.07 INR |
| COP             | Colombia                 | 1 COP = 36.77 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.87 INR |
...
| HUF             | Hungary                 | 1 HUF = 3.29 INR |
| IDR             | Indonesia                 | 1 IDR = 169.49 INR |
...
| MGA             | Madagascar                 | 1 MGA = 45.28 INR |
...
| TZS             | Tanzania                 | 1 TZS = 25.29 INR |
| UAH             | Ukraine                 | 1 UAH = 0.43 INR |
| UGX             | Uganda                 | 1 UGX = 34.80 INR |
| UYU             | Uruguay                 | 1 UYU = 0.39 INR |
| UZS             | Uzbekistan                 | 1 UZS = 119.46 INR |
