...
## 📅 Last Updated: **2026-09-17 03:53:04 UTC**
...
| BDT             | Bangladesh                 | 1 BDT = 1.24 INR |
| BGN             | Bulgaria                 | 1 BGN = 0.02 INR |
| BHD             | Bahrain                 | 1 BHD = 0.00 INR |
| BIF             | Burundi                 | 1 BIF = 30.11 INR |
...
| COP             | Colombia                 | 1 COP = 31.34 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.50 INR |
...
| KHR             | Cambodia                 | 1 KHR = 40.77 INR |
| KMF             | Comoros                 | 1 KMF = 4.28 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 13.81 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.48 INR |
| LAK             | Laos                 | 1 LAK = 225.38 INR |
| LBP             | Lebanon                 | 1 LBP = 901.58 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.34 INR |
| LRD             | Liberia                 | 1 LRD = 1.75 INR |
...
| MGA             | Madagascar                 | 1 MGA = 43.53 INR |
...
| SSP             | Unknown Country                 | 1 SSP = 56.58 INR |
...
| TRY             | Turkey                 | 1 TRY = 0.49 INR |
| TTD             | Trinidad and Tobago                 | 1 TTD = 0.07 INR |
| TWD             | Taiwan                 | 1 TWD = 0.32 INR |
| TZS             | Tanzania                 | 1 TZS = 26.45 INR |
| UAH             | Ukraine                 | 1 UAH = 0.45 INR |
| UGX             | Uganda                 | 1 UGX = 39.42 INR |
| UYU             | Uruguay                 | 1 UYU = 0.41 INR |
| UZS             | Uzbekistan                 | 1 UZS = 118.70 INR |
| VES             | Unknown Country                 | 1 VES = 8.45 INR |
| VND             | Vietnam                 | 1 VND = 259.98 INR |
