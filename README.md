...
## 📅 Last Updated: **2025-05-05 16:26:04 UTC**
...
| TZS             | Tanzania                 | 1 TZS = 26.86 INR |
| UAH             | Ukraine                 | 1 UAH = 0.42 INR |
| UGX             | Uganda                 | 1 UGX = 36.54 INR |
| UYU             | Uruguay                 | 1 UYU = 0.42 INR |
| UZS             | Uzbekistan                 | 1 UZS = 129.03 INR |
| VES             | Unknown Country                 | 1 VES = 0.89 INR |
| VND             | Vietnam                 | 1 VND = 259.57 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.21 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.78 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.78 INR |
