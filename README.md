...
## 📅 Last Updated: **2025-03-14 16:23:11 UTC**
...
| HUF             | Hungary                 | 1 HUF = 3.68 INR |
| IDR             | Indonesia                 | 1 IDR = 163.82 INR |
| ILS             | Israel                 | 1 ILS = 0.04 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.87 INR |
| IQD             | Iraq                 | 1 IQD = 13.08 INR |
| IRR             | Iran                 | 1 IRR = 421.01 INR |
| ISK             | Iceland                 | 1 ISK = 1.35 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.49 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 36.64 INR |
| UYU             | Uruguay                 | 1 UYU = 0.42 INR |
| UZS             | Uzbekistan                 | 1 UZS = 129.39 INR |
| VES             | Unknown Country                 | 1 VES = 0.65 INR |
| VND             | Vietnam                 | 1 VND = 255.02 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.23 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 6.04 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.04 INR |
