...
## 📅 Last Updated: **2026-07-16 02:42:04 UTC**
...
| TRY             | Turkey                 | 1 TRY = 0.47 INR |
| TTD             | Trinidad and Tobago                 | 1 TTD = 0.07 INR |
| TWD             | Taiwan                 | 1 TWD = 0.32 INR |
| TZS             | Tanzania                 | 1 TZS = 26.30 INR |
| UAH             | Ukraine                 | 1 UAH = 0.45 INR |
| UGX             | Uganda                 | 1 UGX = 36.79 INR |
| UYU             | Uruguay                 | 1 UYU = 0.40 INR |
| UZS             | Uzbekistan                 | 1 UZS = 120.34 INR |
| VES             | Unknown Country                 | 1 VES = 7.25 INR |
| VND             | Vietnam                 | 1 VND = 262.62 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.20 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.72 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.72 INR |
| XPF             | CFP Franc                 | 1 XPF = 1.04 INR |
