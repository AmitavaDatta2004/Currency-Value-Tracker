...
## 📅 Last Updated: **2025-12-23 08:31:07 UTC**
...
| HUF             | Hungary                 | 1 HUF = 3.31 INR |
| IDR             | Indonesia                 | 1 IDR = 167.95 INR |
...
| LAK             | Laos                 | 1 LAK = 215.86 INR |
| LBP             | Lebanon                 | 1 LBP = 892.31 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.09 INR |
| LRD             | Liberia                 | 1 LRD = 1.76 INR |
...
| TZS             | Tanzania                 | 1 TZS = 24.73 INR |
| UAH             | Ukraine                 | 1 UAH = 0.42 INR |
| UGX             | Uganda                 | 1 UGX = 35.91 INR |
| UYU             | Uruguay                 | 1 UYU = 0.39 INR |
| UZS             | Uzbekistan                 | 1 UZS = 119.55 INR |
| VES             | Unknown Country                 | 1 VES = 2.82 INR |
| VND             | Vietnam                 | 1 VND = 263.36 INR |
