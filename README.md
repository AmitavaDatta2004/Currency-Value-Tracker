...
## 📅 Last Updated: **2025-01-14 08:22:15 UTC**
...
| IDR             | Indonesia                 | 1 IDR = 162.70 INR |
...
| LAK             | Laos                 | 1 LAK = 217.09 INR |
| LBP             | Lebanon                 | 1 LBP = 895.12 INR |
...
| MGA             | Madagascar                 | 1 MGA = 46.85 INR |
...
| PYG             | Paraguay                 | 1 PYG = 78.32 INR |
| QAR             | Qatar                 | 1 QAR = 0.04 INR |
| RON             | Romania                 | 1 RON = 0.05 INR |
| RSD             | Serbia                 | 1 RSD = 1.14 INR |
| RUB             | Russia                 | 1 RUB = 1.03 INR |
| RWF             | Rwanda                 | 1 RWF = 13.92 INR |
...
| UZS             | Uzbekistan                 | 1 UZS = 129.04 INR |
| VES             | Unknown Country                 | 1 VES = 0.54 INR |
| VND             | Vietnam                 | 1 VND = 253.85 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.19 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 6.40 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.40 INR |
