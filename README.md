...
## 📅 Last Updated: **2025-04-10 08:26:11 UTC**
...
| COP             | Colombia                 | 1 COP = 43.02 INR |
| CRC             | Costa Rica                 | 1 CRC = 5.17 INR |
...
| HUF             | Hungary                 | 1 HUF = 3.74 INR |
| IDR             | Indonesia                 | 1 IDR = 169.54 INR |
| ILS             | Israel                 | 1 ILS = 0.04 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.86 INR |
| IQD             | Iraq                 | 1 IQD = 13.10 INR |
| IRR             | Iran                 | 1 IRR = 421.23 INR |
| ISK             | Iceland                 | 1 ISK = 1.33 INR |
...
| LBP             | Lebanon                 | 1 LBP = 901.62 INR |
| LKR             | Sri Lanka                 | 1 LKR = 2.97 INR |
| LRD             | Liberia                 | 1 LRD = 2.00 INR |
| LSL             | Lesotho                 | 1 LSL = 0.20 INR |
...
| NAD             | Namibia                 | 1 NAD = 0.20 INR |
| NGN             | Nigeria                 | 1 NGN = 15.68 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.01 INR |
