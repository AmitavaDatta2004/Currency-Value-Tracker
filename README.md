...
## 📅 Last Updated: **2025-02-14 16:20:03 UTC**
...
| HUF             | Hungary                 | 1 HUF = 3.82 INR |
| IDR             | Indonesia                 | 1 IDR = 161.95 INR |
...
| LAK             | Laos                 | 1 LAK = 216.74 INR |
| LBP             | Lebanon                 | 1 LBP = 892.98 INR |
...
| MGA             | Madagascar                 | 1 MGA = 46.98 INR |
...
| PYG             | Paraguay                 | 1 PYG = 78.58 INR |
| QAR             | Qatar                 | 1 QAR = 0.04 INR |
| RON             | Romania                 | 1 RON = 0.05 INR |
| RSD             | Serbia                 | 1 RSD = 1.11 INR |
| RUB             | Russia                 | 1 RUB = 0.92 INR |
| RWF             | Rwanda                 | 1 RWF = 13.99 INR |
...
| UZS             | Uzbekistan                 | 1 UZS = 129.58 INR |
| VES             | Unknown Country                 | 1 VES = 0.62 INR |
| VND             | Vietnam                 | 1 VND = 253.90 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.24 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 6.25 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.25 INR |
