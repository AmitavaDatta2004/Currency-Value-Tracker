...
## 📅 Last Updated: **2026-03-09 02:23:03 UTC**
...
| HUF             | Hungary                 | 1 HUF = 3.43 INR |
| IDR             | Indonesia                 | 1 IDR = 169.86 INR |
| ILS             | Israel                 | 1 ILS = 0.03 INR |
| IMP             | Isle of Man                 | 1 IMP = 0.01 INR |
| INR             | India                 | 1 INR = 0.92 INR |
| IQD             | Iraq                 | 1 IQD = 13.16 INR |
| IRR             | Iran                 | 1 IRR = 13207.00 INR |
| ISK             | Iceland                 | 1 ISK = 1.26 INR |
...
| KMF             | Comoros                 | 1 KMF = 4.24 INR |
| KPW             | North Korea                 | 1 KPW = 9.00 INR |
| KRW             | South Korea                 | 1 KRW = 14.98 INR |
| KWD             | Kuwait                 | 1 KWD = 0.00 INR |
| KYD             | Cayman Islands                 | 1 KYD = 0.01 INR |
| KZT             | Kazakhstan                 | 1 KZT = 4.96 INR |
| LAK             | Laos                 | 1 LAK = 215.11 INR |
| LBP             | Lebanon                 | 1 LBP = 899.57 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.13 INR |
...
| MGA             | Madagascar                 | 1 MGA = 41.83 INR |
| MKD             | North Macedonia                 | 1 MKD = 0.53 INR |
| MMK             | Myanmar (Burma)                 | 1 MMK = 21.01 INR |
...
| PHP             | Philippines                 | 1 PHP = 0.60 INR |
| PKR             | Pakistan                 | 1 PKR = 2.81 INR |
| PLN             | Poland                 | 1 PLN = 0.04 INR |
| PYG             | Paraguay                 | 1 PYG = 65.72 INR |
...
| TZS             | Tanzania                 | 1 TZS = 25.67 INR |
| UAH             | Ukraine                 | 1 UAH = 0.44 INR |
| UGX             | Uganda                 | 1 UGX = 36.71 INR |
| UYU             | Uruguay                 | 1 UYU = 0.39 INR |
| UZS             | Uzbekistan                 | 1 UZS = 121.30 INR |
| VES             | Unknown Country                 | 1 VES = 4.25 INR |
| VND             | Vietnam                 | 1 VND = 262.88 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.19 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.70 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.70 INR |
