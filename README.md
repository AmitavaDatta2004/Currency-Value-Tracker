...
## 📅 Last Updated: **2026-03-29 02:37:07 UTC**
...
| CDF             | Democratic Republic of the Congo                 | 1 CDF = 22.83 INR |
...
| COP             | Colombia                 | 1 COP = 36.63 INR |
| CRC             | Costa Rica                 | 1 CRC = 4.63 INR |
...
| LAK             | Laos                 | 1 LAK = 216.79 INR |
| LBP             | Lebanon                 | 1 LBP = 892.56 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.14 INR |
...
| MGA             | Madagascar                 | 1 MGA = 41.54 INR |
| MKD             | North Macedonia                 | 1 MKD = 0.53 INR |
| MMK             | Myanmar (Burma)                 | 1 MMK = 21.02 INR |
| MNT             | Mongolia                 | 1 MNT = 35.72 INR |
...
| UZS             | Uzbekistan                 | 1 UZS = 121.55 INR |
