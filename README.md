...
## 📅 Last Updated: **2025-05-17 01:39:04 UTC**
...
| HUF             | Hungary                 | 1 HUF = 3.61 INR |
| IDR             | Indonesia                 | 1 IDR = 164.94 INR |
...
| TZS             | Tanzania                 | 1 TZS = 27.06 INR |
| UAH             | Ukraine                 | 1 UAH = 0.42 INR |
| UGX             | Uganda                 | 1 UGX = 36.71 INR |
| UYU             | Uruguay                 | 1 UYU = 0.42 INR |
| UZS             | Uzbekistan                 | 1 UZS = 130.08 INR |
| VES             | Unknown Country                 | 1 VES = 0.94 INR |
| VND             | Vietnam                 | 1 VND = 259.21 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.20 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.88 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.88 INR |
