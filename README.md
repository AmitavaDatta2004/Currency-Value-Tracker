...
## 📅 Last Updated: **2026-01-28 08:35:04 UTC**
...
| MXN             | Mexico                 | 1 MXN = 0.17 INR |
| MYR             | Malaysia                 | 1 MYR = 0.04 INR |
| MZN             | Mozambique                 | 1 MZN = 0.64 INR |
| NAD             | Namibia                 | 1 NAD = 0.16 INR |
| NGN             | Nigeria                 | 1 NGN = 14.01 INR |
| NIO             | Nicaragua                 | 1 NIO = 0.36 INR |
| NOK             | Norway                 | 1 NOK = 0.10 INR |
| NPR             | Nepal                 | 1 NPR = 1.46 INR |
...
| PHP             | Philippines                 | 1 PHP = 0.59 INR |
| PKR             | Pakistan                 | 1 PKR = 2.78 INR |
| PLN             | Poland                 | 1 PLN = 0.03 INR |
| PYG             | Paraguay                 | 1 PYG = 66.48 INR |
| QAR             | Qatar                 | 1 QAR = 0.04 INR |
| RON             | Romania                 | 1 RON = 0.04 INR |
| RSD             | Serbia                 | 1 RSD = 0.98 INR |
| RUB             | Russia                 | 1 RUB = 0.76 INR |
| RWF             | Rwanda                 | 1 RWF = 14.47 INR |
...
| SLE             | Sierra Leone                 | 1 SLE = 0.24 INR |
...
| STN             | Unknown Country                 | 1 STN = 0.20 INR |
| SVC             | El Salvador                 | 1 SVC = 0.09 INR |
| SYP             | Syria                 | 1 SYP = 110.60 INR |
| SZL             | Swaziland                 | 1 SZL = 0.16 INR |
...
| TRY             | Turkey                 | 1 TRY = 0.43 INR |
| TTD             | Trinidad and Tobago                 | 1 TTD = 0.07 INR |
| TWD             | Taiwan                 | 1 TWD = 0.31 INR |
| TZS             | Tanzania                 | 1 TZS = 25.44 INR |
| UAH             | Ukraine                 | 1 UAH = 0.43 INR |
| UGX             | Uganda                 | 1 UGX = 35.41 INR |
| UYU             | Uruguay                 | 1 UYU = 0.37 INR |
| UZS             | Uzbekistan                 | 1 UZS = 120.00 INR |
| VES             | Unknown Country                 | 1 VES = 3.58 INR |
| VND             | Vietnam                 | 1 VND = 260.74 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.20 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 5.47 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 5.47 INR |
| XPF             | CFP Franc                 | 1 XPF = 0.99 INR |
| YER             | Yemen                 | 1 YER = 2.38 INR |
| ZAR             | South Africa                 | 1 ZAR = 0.16 INR |
| ZMK             | Zambia (Old Currency)                 | 1 ZMK = 90.01 INR |
| ZMW             | Zambia                 | 1 ZMW = 0.20 INR |
