...
## 📅 Last Updated: **2025-03-06 16:23:12 UTC**
...
| KHR             | Cambodia                 | 1 KHR = 39.86 INR |
| KMF             | Comoros                 | 1 KMF = 4.57 INR |
...
| LAK             | Laos                 | 1 LAK = 216.71 INR |
| LBP             | Lebanon                 | 1 LBP = 895.28 INR |
| LKR             | Sri Lanka                 | 1 LKR = 2.95 INR |
| LRD             | Liberia                 | 1 LRD = 2.00 INR |
...
| MGA             | Madagascar                 | 1 MGA = 46.16 INR |
...
| PYG             | Paraguay                 | 1 PYG = 79.05 INR |
| QAR             | Qatar                 | 1 QAR = 0.04 INR |
| RON             | Romania                 | 1 RON = 0.05 INR |
| RSD             | Serbia                 | 1 RSD = 1.09 INR |
| RUB             | Russia                 | 1 RUB = 0.90 INR |
| RWF             | Rwanda                 | 1 RWF = 14.03 INR |
| SAR             | Saudi Arabia                 | 1 SAR = 0.04 INR |
| SBD             | Solomon Islands                 | 1 SBD = 0.09 INR |
...
| TZS             | Tanzania                 | 1 TZS = 26.13 INR |
| UAH             | Ukraine                 | 1 UAH = 0.41 INR |
| UGX             | Uganda                 | 1 UGX = 36.69 INR |
| UYU             | Uruguay                 | 1 UYU = 0.43 INR |
| UZS             | Uzbekistan                 | 1 UZS = 128.95 INR |
| VES             | Unknown Country                 | 1 VES = 0.64 INR |
| VND             | Vietnam                 | 1 VND = 255.20 INR |
| VUV             | Vanuatu                 | 1 VUV = 1.25 INR |
| WST             | Samoa                 | 1 WST = 0.03 INR |
| XAF             | Unknown Country                 | 1 XAF = 6.09 INR |
...
| XOF             | West African CFA Franc (XOF)                 | 1 XOF = 6.09 INR |
| XPF             | CFP Franc                 | 1 XPF = 1.11 INR |
| YER             | Yemen                 | 1 YER = 2.47 INR |
| ZAR             | South Africa                 | 1 ZAR = 0.18 INR |
| ZMK             | Zambia (Old Currency)                 | 1 ZMK = 90.01 INR |
| ZMW             | Zambia                 | 1 ZMW = 0.29 INR |
