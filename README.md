...
| HUF             | Hungary                 | 1 HUF = 3.49 INR |
| IDR             | Indonesia                 | 1 IDR = 162.93 INR |
...
| KZT             | Kazakhstan                 | 1 KZT = 5.12 INR |
| LAK             | Laos                 | 1 LAK = 215.85 INR |
| LBP             | Lebanon                 | 1 LBP = 898.55 INR |
| LKR             | Sri Lanka                 | 1 LKR = 3.00 INR |
...
| MGA             | Madagascar                 | 1 MGA = 44.80 INR |
...
| TZS             | Tanzania                 | 1 TZS = 25.85 INR |
| UAH             | Ukraine                 | 1 UAH = 0.42 INR |
| UGX             | Uganda                 | 1 UGX = 35.96 INR |
| UYU             | Uruguay                 | 1 UYU = 0.41 INR |
| UZS             | Uzbekistan                 | 1 UZS = 126.98 INR |
| VES             | Unknown Country                 | 1 VES = 1.01 INR |
| VND             | Vietnam                 | 1 VND = 260.75 INR |
